...
- (UIButton *)albumButton {
    if (!_albumButton) {
        ...
        [_albumButton setTitleColor:kbTextColor forState:UIControlStateNormal];
...
- (UIButton *)editButton {
    if (!_editButton) {
        ...
        [_editButton setTitleColor:kbTextColor forState:UIControlStateNormal];
...
- (UIButton *)orignalButton {
    if (!_orignalButton) {
        ...
        [_orignalButton setTitleColor:kbTextColor forState:UIControlStateNormal];
        [_orignalButton setTitleColor:kbTextColor forState:UIControlStateSelected];
...
- (UIButton *)settingButton {
    if (!_settingButton) {
        ...
        [_settingButton setTitleColor:kbTextColor forState:UIControlStateNormal];
